...
class EngineRevIntervalsTest extends \PHPUnit_Framework_TestCase
{
  ...
  */
  protected static function getMethod($name) {
    $class = new ReflectionClass('TdiDean\EngineTools\Dyno\Calculate\EngineRevIntervals');
  ...
  public function testHasPowerIntervals(){
      $shiftPoints = new EngineRevIntervals($this->_powerIntervals);
      $result = $shiftPoints->hasPowerIntervals();
      $this->assertTrue($result);
  }

  public function testHasTorqueIntervals(){
      $shiftPoints = new EngineRevIntervals(false, $this->_torqueIntervals);
      $result = $shiftPoints->hasTorqueIntervals();
      $this->assertTrue($result);
  }

  public function testHasNoIntervals(){
      $shiftPoints = new EngineRevIntervals();
  ...
  public function testPrivateFigurePercent() {
    ...
    $shiftPoints = new EngineRevIntervals($this->_powerIntervals, $this->_torqueIntervals);
