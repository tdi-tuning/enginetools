...
use TdiDean\EngineTools\Dyno\EngineStockVsTunedDyno;
...
class EngineStockVsTunedDynoTest extends \PHPUnit_Framework_TestCase
{
  ...
  public function setUp(){
    $this->_stockEngine = new Engine(115, false, false, false, 275);
    $this->_tunedEngine = new Engine(127, false, false, false, 303, 'tuned');
  }

  /**
  * Pass over stock and tuned engines with rev intervals to return dyno points as an array.
  */
  public function testReturnFiguresAsArray(){
        $engineDyno = new EngineStockVsTunedDyno($this->_stockEngine, $this->_tunedEngine, $this->_powerIntervals, $this->_torqueIntervals);
    ...
    /**
    * Pass over stock and tuned engines without any rev intervals.
    */
    public function testReturnFiguresAsArrayWithoutIntervals(){
      $engineDyno = new EngineStockVsTunedDyno($this->_stockEngine, $this->_tunedEngine);
      $results = $engineDyno->returnFigures(false);
      $this->assertFalse($results);
    }

    /**
    * Pass over stock and tuned engines with only power rev intervals.
    */
    public function testReturnFiguresAsArrayWithOnlyPowerIntervals(){
      $engineDyno = new EngineStockVsTunedDyno($this->_stockEngine, $this->_tunedEngine, $this->_powerIntervals);
      $results = $engineDyno->returnFigures(false);
      $this->assertArraySubset([
            'stock' => [
              'power' => [1000 => 17.71, 1500 => 29.56, 2000 => 56.12, 2500 => 69.46, 3000 => 78.2, 3500 => 87.4, 4000 => 94.3, 4500 => 100.05, 5000 => 106.95, 5500 => 111.55, 6000 => 115],
    ...
    /**
    * Pass over stock and tuned engines with only torque rev intervals.
    */
    public function testReturnFiguresAsArrayWithOnlyTorqueIntervals(){
      $engineDyno = new EngineStockVsTunedDyno($this->_stockEngine, $this->_tunedEngine, false, $this->_torqueIntervals);
      $results = $engineDyno->returnFigures(false);
      $this->assertArraySubset([
        'stock' => [
          'torque' => [1000 => 85.42, 1500 => 154.74, 2000 => 237.24, 2500 => 260.78, 3000 => 264.28, 3500 => 275, 4000 => 271.26, 4500 => 263.89, 5000 => 258.42, 5500 => 245.88, 6000 => 221.76]
    ...
    */
    ...
    /**
    * Pass over stock engine and tuned engine with rev intervals to return dyno points as a google ready json array.
    */
